...
func WriteBestNode(dbTx database.Tx, node *StakeNode, hash *chainhash.Hash, dropReversionData bool) error {
	...
	if node.height >= uint32(node.params.StakeEnabledHeight-1) {

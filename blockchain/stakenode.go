...
func (b *BlockChain) fetchStakeNode(node *blockNode) (*stake.StakeNode, error) {
	...
	for e := attachNodes.Front(); e != nil; e = e.Next() {
		...
		// The reorganizeNode will give you the fork point again;
		// ignore it because we already handled it.
		//if *n.hash == *mostRecentlyConnected.hash &&
		//	n.height == mostRecentlyConnected.height {
		//	continue
		//}
	...
	/*
		...
		fmt.Printf("FINAL RETURNED STAKE NODE %v %v %v\n", node.stakeNode.Height(), node.height, node.hash)
	*/
